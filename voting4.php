...
<body>
	...
	<div class="container">
		...
		<a class="brand">
		<img src="admin/images/ITClub.jpg" width="60" height="60">
 	</a>
	<a class="brand">
	 <h2>IT CLub Annual Election</h2>
	 <div class="chmsc_nav"><font size="4" color="white">Institute of Information Technology,NSTU</font></div>
 	</a>
...
<?php 
$governor=mysqli_query($conn,"select * from candidate where Position='President'")or die(mysqli_error());
...
<font color="white">Candidate for Secretary</font>
</div>

<div class="governor">
<div class="gov-margin">
<?php 
$vice=mysqli_query($conn,"select * from candidate where Position='Secretary'")or die(mysqli_error());
