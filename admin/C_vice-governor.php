...
<div class="navbar">
	...
	<ul class="nav nav-pills">
	  ...
	  <li class=""><a  href="voter_list.php"><i class="icon-align-justify icon-large"></i>Voters List</a></li>  
		 <li class="active"><a  href="canvassing_report.php"><i class="icon-book icon-large"></i>Poll Report</a></li>
    ...
    <li  class="active"><a href="C_vice-governor.php"><font color="white">Secretary</font></a></li>
	...
	<?php
	$query=mysqli_query($conn,"select  * from candidate where Position='President'");
